...
class JobLocationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('admin.job.job-location.index', compact('jobLocations'));
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.job.job-location.create', compact('countries'));
    }
    ...
    public function edit(string $id): View
    {
        ...
        return view('admin.job.job-location.edit', compact('jobLocation', 'countries', 'states'));
    }
