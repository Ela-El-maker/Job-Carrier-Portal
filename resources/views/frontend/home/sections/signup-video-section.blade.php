<section id="signup-video" style="background-image: url()">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 signup-sec ptb80 text-center">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <img src="{{ asset('images/icons/arrow.svg') }}" alt=""
                        class="signup-arrow visible-lg-block">
                </div>
            ...
            {{-- <div class="col-md-6 video-sec overlay-gradient text-center d-flex align-items-center justify-content-center"
                style="position: relative;"> --}}
<div class="col-md-6 video-sec overlay-gradient text-center d-flex align-items-center justify-content-center"
     style="position: relative; height: 600px; overflow: hidden;">

                @if ($customSection?->media_type === 'image' && $customSection?->media_path)
                    <img src="{{ asset($customSection?->media_path) }}" alt="Section Image"
                        class="img-fluid w-100 h-100"
                        {{-- style="object-fit: cover; object-position: center; position: absolute; top: 0; left: 0;"> --}}
                        style="object-fit: cover; object-position: center; width: 100%; height: 100%; position: absolute; top: 0; left: 0;">
                @elseif($customSection?->media_type === 'video' && $customSection?->media_path)

                    <a href="{{ asset($customSection?->media_path) }}" class="popup-video"
