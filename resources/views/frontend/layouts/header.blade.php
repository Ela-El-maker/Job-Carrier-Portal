                ...
                <div class="col-md-6 col-xs-12">
                    <ul class="social-btns list-inline text-right">
                        @foreach ($headerSocials as $link)
                            <li>
                                <a href="{{ $link->url ?? '#' }}" class="social-btn-roll" aria-label="{{ $link->name ?? 'Social media' }}">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-8">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <img src="{{ $header->logo ?? asset('images/logo.png') }}" alt="Company Logo">
                    </a>
                </div>
                    ...
                    <div class="collapse navbar-collapse main-nav" id="main-nav">
                        <ul class="nav navbar-nav navbar-right single-line-nav">
                            @foreach ($navigationMenu as $menu)
                                @if (!empty($menu['child']))
                                    <li class="dropdown">
                                        <a href="{{ $menu['link'] ?? '#' }}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
