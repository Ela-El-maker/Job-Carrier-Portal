            ...
            <div class="card-body ">
                <form action="{{ route('admin.hero.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control {{ hasError($errors, 'sub_title') }}" id="editor" name="sub_title"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="show_at_home" class="form-control select2 {{ hasError($errors, 'show_at_home') }}"
                            id="show_at_home">
                            <option value="1" {{ old('show_at_home') == '1' ? 'selected' : '' }}>
                                Yes</option>
                            <option value="0" {{ old('show_at_home') == '0' ? 'selected' : '' }}>
                                No</option>
                        </select>
