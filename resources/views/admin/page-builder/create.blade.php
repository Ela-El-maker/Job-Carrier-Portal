            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="editor" rows="10">{{ old('content') }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="show" class="form-control select2 @error('show') is-invalid @enderror">
                            <option value="" {{ old('show') === null ? 'selected' : '' }}>Pending</option>
